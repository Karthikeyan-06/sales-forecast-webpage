...
con_string = "mongodb+srv://Karthikeyan-06:karthi@cluster0.msvorj1.mongodb.net"
client = pymongo.MongoClient(con_string)
db = client.get_database('demodata')
...
csv_file_path ="C:\\Users\\Kanthavelu\\Desktop\\csvtojson\\stores.csv"
json_file_path = "C:\\Users\\Kanthavelu\\Desktop\\csvtojson\\data.json"
...
def project_api_routes(endpoints):
    ...
    def file_upload():
        ...
        try:
            ...
            future_df['forecast'] = results.predict(start = 19, end =30, dynamic= True)  
            future_df[['Sales', 'forecast']].plot(figsize=(12, 8))
            print(future_df[['Sales', 'forecast']])
            plt.plot()
            plt.savefig('plot.jpg')
            image = cv2.imread('plot.jpg')
            path = r"C:\Users\T.RAJASEKARAPANDIAN\OneDrive\Desktop\PYTHON\ANGULAR\karthik\src\assets"
